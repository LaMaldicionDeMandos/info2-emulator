...
class Info2GuiApplication : public QGuiApplication
{
    ...
    Q_PROPERTY(QString lcd0 READ lcd0 WRITE setLcds0 NOTIFY lcdsChanged)
    Q_PROPERTY(QString lcd1 READ lcd1 WRITE setLcds1 NOTIFY lcdsChanged)
public:
...
public slots:
    ...
    void setLcds0(const QString lcdString);
    void setLcds1(const QString lcdString);
